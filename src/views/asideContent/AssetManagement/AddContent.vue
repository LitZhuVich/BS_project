      ...
      <el-form ref="ruleFormRef" :model="ruleForm" :rules="rules" label-width="120px" class="demo-ruleForm"
        ...
        <p>
          <el-form-item label="资产模板" class="scp_btn">
            <el-select v-model="ruleForm.asset_module" class="m-2" placeholder="请选择模板">
          ...
          <el-form-item label="设备型号">
            <el-input v-model="ruleForm.asset_model" placeholder="请输入资产型号" />
          </el-form-item>
        </p>
        <p>
          <el-form-item label="来源" class="scp_btn">
            <el-select v-model="ruleForm.asset_source" class="m-2" placeholder="请选择来源">
...
const submitForm = async (formEl: FormInstance | undefined) => {
  ...
  await formEl.validate(async (valid, fields) => {
    if (valid) {
      const resOrder = await apiClient.post<any>("/asset/add", ruleForm);
      formEl.resetFields();
    }
  });
};
